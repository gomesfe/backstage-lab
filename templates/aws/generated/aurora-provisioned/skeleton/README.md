...
Aurora com capacidade provisionada — Cluster Aurora com classe de instância fixa, para carga previsível.

Gerado pelo template `atlas-template-aurora-provisioned`.
